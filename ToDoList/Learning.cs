...
namespace ToDoList
{
    public partial class Learning : UserControl
    {
        ...
        public void addItem(string text, string date)
        {
            ...
            if (!panel2.Controls.ContainsKey(text))
            {
        ...
        public void addTargets(string insert, string createDate)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        SQL.Open();
                        SqlCommand commandSec = new SqlCommand("INSERT INTO TargetTab (TargetText,TargetCreateDate,TargetId) VALUES ('" + insert + "','" + createDate + "','1')", SQL);
